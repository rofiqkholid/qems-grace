...
@section('title', 'Check Item Master')
...
<div class="lg:ml-20 min-h-screen flex flex-col bg-slate-50">
    ...
    <main class="flex-1 p-6">
        <!-- Page Title -->
        <div class="mb-6">
            <h1 class="text-lg sm:text-2xl font-bold text-slate-800">Check Item Master</h1>
            <p class="text-slate-500 text-xs sm:text-sm mt-1">Manage check item definitions and their associated details</p>
        </div>
        ...
        <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
            ...
            <div class="p-6">
                <table id="checkItemTable" class="qms-table w-full min-w-[1200px]">
                    <thead>
                        <tr>
...
<div id="createModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl w-full max-w-2xl transform transition-all">
            ...
            <form id="createForm" action="{{ route('master.check_item.store') }}" method="POST">
                @csrf
...
<div id="editModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl w-full max-w-2xl transform transition-all">
            ...
            <form id="editForm" action="{{ route('master.check_item.update') }}" method="POST">
                @csrf
...
<script>
    ...
    $(document).on('keyup', '#searchInput', function() {
        ...
        searchTimer = setTimeout(function() {
            $('#checkItemTable').DataTable().search($(self).val()).draw();
        }, 500);
    });
