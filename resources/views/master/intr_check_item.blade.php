        ...
        <div class="bg-white rounded-xl w-full max-w-2xl transform transition-all">
            ...
            <form action="{{ route('master.intr_check_item.store') }}" method="POST">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Check Item (EN) <span class="text-red-500">*</span></label>
                        <textarea name="check_item_en" rows="3" required class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" placeholder="Description in English..."></textarea>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl w-full max-w-2xl transform transition-all">
            ...
            <form action="{{ route('master.intr_check_item.update') }}" method="POST">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Check Item (EN) <span class="text-red-500">*</span></label>
                        <textarea name="check_item_en" id="edit_check_item_en" rows="3" required class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"></textarea>
                    </div>
                </div>
                <div class="p-6 border-t border-slate-100 bg-slate-50/50 flex justify-end gap-3 rounded-b-xl">
