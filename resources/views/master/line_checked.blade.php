...
<div class="lg:ml-20 min-h-screen flex flex-col bg-slate-50">
    ...
    <main class="flex-1 p-6">
        ...
        <div class="mb-6 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Line Checked Master</h1>
                <p class="text-slate-500 mt-1">Manage process line checked definitions and their associated details</p>
            </div>
        ...
        <div class="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="overflow-x-auto p-6">
                <table id="lineCheckedTable" class="qms-table w-full">
                    <thead>
                        <tr>
