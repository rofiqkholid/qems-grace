...
<div class="lg:ml-20 min-h-screen flex flex-col bg-slate-50">
    ...
    <main class="flex-1 p-6">
        <!-- Page Title -->
        <div class="mb-6">
            <h1 class="text-lg sm:text-2xl font-bold text-slate-800">Department Master</h1>
            <p class="text-slate-500 text-xs sm:text-sm mt-1">Manage department definitions and their associated details</p>
        </div>
        ...
        <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
            ...
            <div class="p-6">
                <table id="departmentTable" class="qms-table w-full min-w-[800px]">
                    <thead>
                        <tr>
