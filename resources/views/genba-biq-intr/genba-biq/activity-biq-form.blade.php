    ...
    <main class="flex-1 p-6">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-base md:text-2xl font-bold text-slate-800">Genba Form BIQ</h1>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden" id="kt_card_{{ $no }}">
                        ...
                        <div x-show="showPopover"
                            ...
                            <div class='text-sm space-y-3 text-slate-600'>
                                ...
                                <div class='flex items-start gap-2'>
                                    ...
                                    <span>Jika terdapat potensi ketidaksesuaian (Warning)</span>
                                </div>
                ...
                <div class="px-8 pb-8 space-y-6">
                    ...
                    <div class="group relative rounded-xl border bg-white p-5 transition-all duration-300"
                        :style="answers[{{ $itemId }}] == 3 ? 'border-color: #fecaca; background-color: rgba(254, 242, 242, 0.1);' : (answers[{{ $itemId }}] == 2 ? 'border-color: #fde68a; background-color: rgba(254, 243, 199, 0.1);' : 'border-color: #f1f5f9;')">
                        ...
                        <div class="flex flex-col lg:flex-row gap-6">
                            ...
                            <div class="flex-shrink-0 flex flex-col sm:flex-row gap-4 lg:w-[550px]">
                                ...
                                <div class="grid grid-cols-3 sm:flex sm:items-center sm:justify-center gap-2 bg-slate-50 rounded-lg p-1.5 w-full sm:w-auto self-start">
                                    ...
                                    2 => ['icon' => 'fa-exclamation-triangle', 'textColor' => '#f59e0b', 'bgColor' => '#fffbeb'],
                                ...
                                <div x-show="answers[{{ $itemId }}] == 3 || answers[{{ $itemId }}] == 2"
                                    x-transition:enter="transition ease-out duration-200"
