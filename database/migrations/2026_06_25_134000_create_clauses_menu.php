...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('t100_menus')->updateOrInsert(
            ...
            [
                ...
                'group_id' => 6,
                'sub_group_id' => 95,
                'menu' => 'data-master/clauses',
                'menu_name' => 'Clauses',
                'icon' => '<span></span>'
            ]
        );

        // Copy permissions from menu 95 (Data Master) to menu 111
    ...
    {
        DB::table('t100_user_menus_permission')->where('id_menus', 111)->delete();
        DB::table('t100_menus')->where('id', 111)->delete();
    }
};
